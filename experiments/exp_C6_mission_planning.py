...
OUT_RUNS    = os.path.join(os.path.dirname(__file__), "results", f"C6_runs{MODEL_TAG}_{GUARDRAIL_SUFFIX}.csv")
OUT_SUMMARY = os.path.join(os.path.dirname(__file__), "results", f"C6_summary{MODEL_TAG}_{GUARDRAIL_SUFFIX}.csv")
OUT_PNG     = os.path.join(os.path.dirname(__file__), "results", f"C6_mission_planning{MODEL_TAG}_{GUARDRAIL_SUFFIX}.png")
...
def run_once(run_idx):
    ...
    agent = _make_agent(f"C6_run{run_idx}")
