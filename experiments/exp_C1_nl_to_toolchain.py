...
OUT_RUNS    = os.path.join(os.path.dirname(__file__), "results", f"C1_runs{MODEL_TAG}_{GUARDRAIL_SUFFIX}.csv")
OUT_SUMMARY = os.path.join(os.path.dirname(__file__), "results", f"C1_summary{MODEL_TAG}_{GUARDRAIL_SUFFIX}.csv")
OUT_PNG     = os.path.join(os.path.dirname(__file__), "results", f"C1_nl_to_toolchain{MODEL_TAG}_{GUARDRAIL_SUFFIX}.png")
...
def run_once(run_idx):
    ...
    agent = _make_agent(f"C1_run{run_idx}")
